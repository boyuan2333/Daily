...
- UI and interaction changes: `docs/UX_DESIGN.md`; consult confirmed decisions in `docs/DAILY_UI_UPDATE_NOTES.md` when relevant. Feedback and proposals do not override core product rules.
